...
<div class="page-banner">
      ...
      <div class="page-banner__content container t-center c-white">
        ...
        <h2 class="headline headline--medium">We think you&rsquo;ll love these cats.</h2>
        <h3 class="headline headline--small">Why don&rsquo;t you check out these felines?</h3>
        <a href="#" class="btn btn--large btn--blue">Find Your Cat</a>
      </div>
    </div>
